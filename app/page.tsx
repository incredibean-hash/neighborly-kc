    ...
    <div className="min-h-screen w-full overflow-x-hidden nkc-app-shell" style={{backgroundColor: theme.bg, color: theme.text, colorScheme: theme.id==='aim' ? 'light' : 'dark'}}>
      ...
      >
        ...
        <button
          ...
          style={{color:navThemeColor}}
        >
          {theme.id==='pip-boy'?<PipBoyIcon name="plus_fab" alt="" className="nkc-pipboy-plus-icon"/>:<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 5v14M5 12h14" fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round"/></svg>}
        </button>
