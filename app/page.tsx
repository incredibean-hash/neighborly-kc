...
draculaFull: { id:'dracula', name:'Dracula', emoji:'🧛', bg:'#282a36', card:'#44475a', text:'#f8f8f2', subtext:'#6272a4', accent:'#ff79c6', border:'#44475a', input:'#44475a', header:'#282a36', pillActive:'#bd93f9', pillTextActive:'#f8f8f2', pillInactive:'#44475a' },
