...
export default function ConnectionsPage(){
 ...
 return <main className="min-h-screen" style={{backgroundColor:theme.bg,color:theme.text}}>
  <header className="p-4" style={{backgroundColor:theme.header,color:'#fff'}}><div className="max-w-3xl mx-auto"><Link href="/people" className="text-xs opacity-70">← People</Link><h1 className="font-black text-2xl">Connections</h1><p className="text-xs opacity-70">Your Neighborly KC network</p></div></header>
