...
export default function PeoplePage(){
  ...
  return <main className="min-h-screen w-full overflow-x-hidden" style={{backgroundColor:theme.bg,color:theme.text}}>
    <header className="nkc-subpage-header sticky top-0 z-20 p-4 shadow-sm" style={{backgroundColor:theme.header,color:'#fff'}}>
