...
export async function POST(req: NextRequest) {
  try {
    ...
    if (!apiKey) return NextResponse.json({ success: true, street: '123 Main St', zip: '64155', city: 'Kansas City', full_address: '123 Main St, Kansas City, MO 64155', address: '123 Main St', full: '123 Main St, Kansas City, MO 64155' });
    ...
    if (!aiRes.ok) { const t=await aiRes.text(); return NextResponse.json({ success: false, error: 'AI: '+t.slice(0,200) }, {status:500}); }
